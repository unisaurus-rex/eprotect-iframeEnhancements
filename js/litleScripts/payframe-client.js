...
var eventHandler = function (e) {
    "use strict";
    if(e.origin !== "https://request-prelive.np-securepaypage-litle.com") {
		return;
	}
    ...
    if (response.ready) {
    	payframeIsReady = true;
    	var payframe = document.getElementById("vantiv-payframe").contentWindow;
        configFromMerchant.action="configure";
        payframe.postMessage(JSON.stringify(configFromMerchant), "https://request-prelive.np-securepaypage-litle.com");
    }
...
var LitlePayframeClient = function (configuration) {
    ...
    var apiVersion = "api2"
    jQuery("#"+div).html("<iframe id='vantiv-payframe' name='vantiv-payframe' frameborder='0' src='https://request-prelive.np-securepaypage-litle.com/LitlePayPage/payframe_"+paypageId+"_"+style+"_"+apiVersion+".html' height='"+height+"' width='100%'></iframe>");
    ...
    return {
        getPaypageRegistrationId : function (message) {
            ...
            var payframe = document.getElementById("vantiv-payframe").contentWindow;
            payframe.postMessage(JSON.stringify(message), "https://request-prelive.np-securepaypage-litle.com");
        },
